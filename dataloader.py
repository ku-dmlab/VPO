...
def get_alpacaeval(split: str, human_prefix: str, human_suffix: str, assistant_prefix: str, assistant_suffix: str, **kwargs) -> Dataset:
    """
...
def get_shp(split: str, human_prefix: str, human_suffix: str, assistant_prefix: str, assistant_suffix: str, tokenizer=None, ratio_count=None, max_prompt_count=None, **kwargs) -> Dataset:
    """
    ...
    Returns:   
        A Dataset instance.
    """
    MAX_PAIRS_PER_PROMPT = max_prompt_count
    MIN_SCORE_RATIO = ratio_count
    ...
    for i, row in enumerate(dataset):
        ...
        if split == 'test':
            data[prompt].best_chosen = row['human_ref_A'] if row['labels'] == 1 else row['human_ref_B']
...
# ------------------------------- UltraFeedback binarized with Score ------------------------------- #

def get_ultrabin(split: str, human_prefix: str, human_suffix: str, assistant_prefix: str, assistant_suffix: str, **kwargs) -> Dataset:
    """
...
def get_hh(split: str, human_prefix: str, human_suffix: str, assistant_prefix: str, assistant_suffix: str, only_helpful = False, only_harmless = False, **kwargs) -> Dataset:
    """
...
def get_hh_helpful(split: str, human_prefix: str, human_suffix: str, assistant_prefix: str, assistant_suffix: str, **kwargs) -> Dataset:
...
def get_hh_harmless(split: str, human_prefix: str, human_suffix: str, assistant_prefix: str, assistant_suffix: str, **kwargs) -> Dataset:
...
def get_oasst(split: str, human_prefix: str, human_suffix: str, assistant_prefix: str, assistant_suffix: str, **kwargs) -> Dataset:
    """
...
class DataLoader:
    ...
    def __init__(self, 
                 ...
                 seed:int = 0,
                 alpacaeval:bool = False,
                 ratio_count:int = None,
                 **kwargs):
        ...
        for name in dataset_names:
            data_kwargs = {'tokenizer': tokenizer, 'ratio_count': ratio_count, 'max_prompt_count': max_prompt_count}
            
            dataset = globals()[f"get_{name}"](split, human_prefix, human_suffix, assistant_prefix, assistant_suffix, **data_kwargs)
    ...
    def __iter__(self):
        ...
        while True:
            ...
            for example in flat_data:
                ...
                batch_element['best_chosen'] = example.best_chosen
    ...
    def __iter__(self):
        ...
        while True:
            ...
            for example, (i,j) in flat_data:
                ...
                batch_element['chosen_scores'] = example.scores[i]
                batch_element['rejected_scores'] = example.scores[j]
                batch.append(batch_element)
